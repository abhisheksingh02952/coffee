  ...
  <div class="row">
   ...
   ?>
    ...
    <main class="col-md-10 ms-sm-auto px-4 py-4">
      ...
      <table id="shopStockTable" class="display table table-striped" style="width:100%">
        <thead>
          <tr>
            <th>Product</th>
            <th>Quantity</th>
      ...
      <div class="clearfix">
            <button type="button" class="update" onclick="window.location.href='shop_stock.php'">Back</button>
      </div>
    </main>
  </div>
</div>
...
<script>
        $(document).ready(function () {
            const shop_id = <?= isset($_SESSION['shop_id']) ? (int)$_SESSION['shop_id'] : 0 ?>;

            $('#shopStockTable').DataTable({
                "ajax": "fetch_shop_products_stock.php?shop_id=" + shop_id,
                "columns": [
                    { "title": "Product" },
                    { "title": "Quantity" },
                    { "title": "Last Updated" }
