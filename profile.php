    ...
    <main class="col-md-10 py-4">
      <form action="" method="POST">
        <div id="data" class="container">
          ...
          <input type="text" placeholder="Enter User ID" name="user_id" id="em_user_id" required>
    ...
    // Profile data update
     $("#profile-update-data").on("click", function(e) {
        ...
        $.ajax({
            ...
            type: "POST",
            data: {  id: id, name: name, phone: phone, email: email, address: address, location: location, pin: pin, em_user_id: em_user_id, password: password },
            success: function(data) {
                if (data) {
